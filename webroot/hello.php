...
$triton['footer'] = <<<HTML
<footer><span class='sitefooter'>Copyright (c) 2016 Anton Persson (anton.persson@outlook.com) | <a href='https://github.com/anton-persson/triton'>Triton på GitHub</a> | <a href='http://validator.w3.org/unicorn/check?ucn_uri=referer&amp;ucn_task=conformance'>Unicorn Validator</a></span></footer>
HTML;
